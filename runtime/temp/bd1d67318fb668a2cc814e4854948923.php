<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"/var/www/chinlingcloud/public/../application/index/view/index/index.html";i:1510646474;s:65:"/var/www/chinlingcloud/public/../application/index/view/base.html";i:1510803549;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8" />
	...
	<body>		
		...
		<div id="banner_index" class="swiper-container  lunbo_app_or_pc_show">
			<div id="lunbo_pc"  class="swiper-container  lunbo_app_or_pc_show">
				<div class="swiper-wrapper">
	        <?php if(is_array($imgdata) || $imgdata instanceof \think\Collection || $imgdata instanceof \think\Paginator): $i = 0; $__LIST__ = $imgdata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$imglist): $mod = ($i % 2 );++$i;?>
	            <div class="swiper-slide">	                
	                <img   src="<?php echo $imglist['caro_img']; ?>"/>
	                
	            </div>	            
	       	<?php endforeach; endif; else: echo "" ;endif; ?>  
	       <!--<?php if(is_array($imgdata) || $imgdata instanceof \think\Collection || $imgdata instanceof \think\Paginator): $i = 0; $__LIST__ = $imgdata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$imglist): $mod = ($i % 2 );++$i;?>
	            <div class="swiper-slide lunbo_app lunbo_app_or_pc">
	                <img  src="<?php echo $imglist['caro_img']; ?>"/>
	            </div>	            
	       <?php endforeach; endif; else: echo "" ;endif; ?>  -->
	        </div>
	        ...
	        <div id="lunbo_app"  class="swiper-container  lunbo_app_or_pc_hidden">
				<div class="swiper-wrapper">
	        <?php if(is_array($shouimgdata) || $shouimgdata instanceof \think\Collection || $shouimgdata instanceof \think\Paginator): $i = 0; $__LIST__ = $shouimgdata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$shouimglist): $mod = ($i % 2 );++$i;?>
	            <div class="swiper-slide">	                
	                <img   src="<?php echo $shouimglist['caro_img']; ?>"/>	                
	            </div>	            
	       	<?php endforeach; endif; else: echo "" ;endif; ?>  
	       <!--<?php if(is_array($imgdata) || $imgdata instanceof \think\Collection || $imgdata instanceof \think\Paginator): $i = 0; $__LIST__ = $imgdata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$imglist): $mod = ($i % 2 );++$i;?>
	            <div class="swiper-slide lunbo_app lunbo_app_or_pc">
		...
		<div id="main_index">
			<div>
				<h3></h3>
				<dl>
					<?php if(is_array($Pattern) || $Pattern instanceof \think\Collection || $Pattern instanceof \think\Paginator): if( count($Pattern)==0 ) : echo "" ;else: foreach($Pattern as $key=>$vo): ?>
					<dd>
						<div class="contain">    
			    			<img class="donut donut-front" src="<?php echo $vo['caro_img']; ?>" alt="Donut front" />	   
			    			<img class="donut donut-back" src="<?php echo $vo['imgtwo']; ?>" alt="Donut back" />			    			
			 			</div>
						<span><?php echo $vo['caro_name']; ?></span>
					</dd>
					<?php endforeach; endif; else: echo "" ;endif; ?>
					<dd class="await">
						<div class="contain">    
			    			<img class="" src="__STATIC__/index/img/genduo.jpg" alt="Donut front" style="border: 1px solid #848486; " />		    			    			
			 			</div>
						<span>更多服务</span>
					</dd>
				</dl>
			...
			<div>
				<ul>
				 <?php if(is_array($ModularData) || $ModularData instanceof \think\Collection || $ModularData instanceof \think\Paginator): $i = 0; $__LIST__ = $ModularData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$mo): $mod = ($i % 2 );++$i;?>
					<li>
						<a href="<?php echo url($mo['action']); ?>">
							<img src="<?php echo $mo['caro_img']; ?>"/>												
							<h4><span><?php echo $mo['caro_name']; ?></span></h4>						
						</a>				
					</li>
				 <?php endforeach; endif; else: echo "" ;endif; ?>	
				</ul>
