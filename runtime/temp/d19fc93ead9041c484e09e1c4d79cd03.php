<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"/var/www/chinlingcloud/public/../application/index/view/news/index.html";i:1525403416;s:65:"/var/www/chinlingcloud/public/../application/index/view/base.html";i:1510803549;s:72:"/var/www/chinlingcloud/public/../application/index/view/public/xdao.html";i:1520902952;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8" />
	...
	<body>		
		...
		<!--<div id="nav_newslist">-->
			<!--<ul>-->
				...
				<!--<li  <?php if($wenid==$son['type_id']): ?> class="on" <?php endif; ?>>					-->
					<!--<a href="<?php echo url('index/news/index',['type_pid'=>$son['type_pid'],'wen_id'=>$son['type_id']]); ?>"><?php echo $son['type_name']; ?></a>				-->
				<!--</li>-->
				<!--<?php endforeach; endif; else: echo "" ;endif; ?>-->
			<!--</ul>-->
<!--</div>-->
		...
		<div id="main_newslist">
			<?php if($newdata != NULL): ?>
			<div class="introduction main_1 show"  >
				<ul>
					 <?php if(is_array($newdata) || $newdata instanceof \think\Collection || $newdata instanceof \think\Paginator): $i = 0; $__LIST__ = $newdata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$son): $mod = ($i % 2 );++$i;?>
					<li>
						<a href="<?php echo url('index/news/info',['id'=>$son['cont_id'],'type_id'=>$son['cont_pid']]); ?>">
							<div><img src="<?php echo $son['cont_img']; ?>"/></div>
							<div class="news_index_main_main">
								<h3><?php echo $son['cont_title']; ?></h3>
								<h4 class="clear">
									<span class="f-left"><i>发表于   </i> <?php echo date("Y-m-d H:i",$son['createtime']); ?></span>
									<span class="f-right"><i>作者: </i> 编辑</span>
								</h4>
							</div>
						</a>
					</li>
			...
			<div class="pages">
        		<h3>
        						<span><a href="<?php echo url('index/news/index',['page'=>1,'type_pid'=>$type_pid,'wen_id'=>$wenid]); ?>">首页</a></span>
        						<?php if($page==1 || $page<'1'): else: ?>
			        			<span><a href="<?php echo url('index/news/index',['page'=>$page-1,'type_pid'=>$type_pid,'wen_id'=>$wenid]); ?>">上一页</a></span>
			        			<?php endif; ?>
			        			<span>第<b><?php echo $page; ?></b>页</span>
			        			<span>共<b><?php echo $maxPage; ?></b>页</span>
			        			<?php if($maxPage==$page || $maxPage<$page): else: ?>
			        			<span><a href="<?php echo url('index/news/index',['page'=>$page+1,'type_pid'=>$type_pid,'wen_id'=>$wenid]); ?>">下一页</a></span>
			        			<?php endif; ?>
			        			<span><a href="<?php echo url('index/news/index',['page'=>$maxPage,'type_pid'=>$type_pid,'wen_id'=>$wenid]); ?>">尾页</a></span>
