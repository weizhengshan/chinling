<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:81:"/var/www/chinlingcloud/public/../application/admin/view/auth_group/auth_gadd.html";i:1531716682;s:65:"/var/www/chinlingcloud/public/../application/admin/view/base.html";i:1531716682;s:74:"/var/www/chinlingcloud/public/../application/admin/view/public/header.html";i:1531716684;s:71:"/var/www/chinlingcloud/public/../application/admin/view/public/nav.html";i:1531899312;}*/ ?>
    ...
    <font style="display:none" class="ad_title" color='red'>名称不能为空！</font>
                            ...
                            <div class="col-sm-6" align="center">
                               <table class="table table-hover">
                                    ...
                                    <tbody>
                                        <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$authRule): $mod = ($i % 2 );++$i;?>
                                            <tr>
                                                <td>
                                                    <label>
...
var url="<?php echo url('admin/auth_group/auth_gadd'); ?>";
