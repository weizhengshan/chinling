<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:73:"/var/www/chinlingcloud/public/../application/index/view/news/recruit.html";i:1510298180;s:65:"/var/www/chinlingcloud/public/../application/index/view/base.html";i:1510803549;s:72:"/var/www/chinlingcloud/public/../application/index/view/public/xdao.html";i:1520902952;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8" />
			...
			<div class="recruitment">
				...
				<div class="recruitment_content clear">
					...
					<?php if(is_array($res) || $res instanceof \think\Collection || $res instanceof \think\Paginator): $i = 0; $__LIST__ = $res;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>	
						<li>
							<h3 class="">
								<span>招聘职位：<b><?php echo $vo['position']; ?></b></span>
								<span>招聘人数：<b><?php echo $vo['num']; ?></b>人</span>
								<span >关注数：<b id="zhi<?php echo $vo['rec_id']; ?>"><?php echo $vo['follow']; ?></b></span>
							</h3>
							<h4 class="clear">
								<span>工作地点：<b><?php echo $vo['place']; ?></b></span>
								<span>职位性质：<b><?php echo !empty($vo['nature'])?'全职':'兼职'; ?></b></span>
								<span>发布时间：<b><?php echo date("Y-m-d",$vo['createtime']); ?></b></span>
								<span class="cli_show_hide" _id="<?php echo $vo['rec_id']; ?>" ><img src="__STATIC__/index/img/f5.png" class="kai"></span>
							</h4>
...
<script type="text/javascript">	
 function ajax_re(_id)
  ...
  var oldtext=$('#zhi'+_id).text();
       $.ajax({
       url:"<?php echo url('index/news/update_a'); ?>",
       type:"post",
       dataType:"json",
       data:"id="+_id,
