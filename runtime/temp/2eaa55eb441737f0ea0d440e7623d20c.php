<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:78:"/var/www/chinlingcloud/public/../application/admin/view/types/types_index.html";i:1531716685;s:65:"/var/www/chinlingcloud/public/../application/admin/view/base.html";i:1531716682;s:74:"/var/www/chinlingcloud/public/../application/admin/view/public/header.html";i:1531716684;s:71:"/var/www/chinlingcloud/public/../application/admin/view/public/nav.html";i:1531899312;}*/ ?>
...
<div id="urHere">DouPHP 管理中心<b>></b><strong>文章分类</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
        <h3><a href="<?php echo url('admin/types/type_add'); ?>" class="actionBtn add">添加分类</a>导航分类</h3>
    <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
	  ...
	  <?php if(is_array($arr) || $arr instanceof \think\Collection || $arr instanceof \think\Paginator): if( count($arr)==0 ) : echo "" ;else: foreach($arr as $key=>$vo): ?>
        ...
        <td align="left"><?php echo $vo['type_name']; ?></td>
        <td><?php echo $vo['type_describe']; ?></td>
        <td><?php echo $vo['action']; ?></td>
        <th align="left"><?php echo $vo['priority']; ?></th>
        <td align="center"><?php echo $vo['type_sort']; ?></td>
        <td align="center"><a  class="layui-btn layui-btn-sm" href="<?php echo url('admin/types/type_edit',['type_id'=>$vo['type_id']]); ?>">编辑</a><a  class="layui-btn layui-btn-sm" href="JavaScript:" onclick="types_dele('确定要删除吗？',<?php echo $vo['type_id']; ?>)">删除</a></td>
     </tr>
      <?php endforeach; endif; else: echo "" ;endif; ?>     
          </table>
           </div>
...
function types_dele(message, id) {
        layer.open({
            ...
            btn : ['是','否'],
            yes : function(){
                var url="<?php echo url('admin/types/type_dele'); ?>";
        var success_url="<?php echo url('admin/types/types_index'); ?>";
        $.post(url,{'type_id':id},function(result){
        if(result.status=='4')
          {
          dialog.success(result.message,success_url);
