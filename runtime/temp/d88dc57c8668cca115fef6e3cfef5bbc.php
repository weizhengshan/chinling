<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:82:"/var/www/chinlingcloud/public/../application/admin/view/auth_group/auth_glist.html";i:1531716682;s:65:"/var/www/chinlingcloud/public/../application/admin/view/base.html";i:1531716682;s:74:"/var/www/chinlingcloud/public/../application/admin/view/public/header.html";i:1531716684;s:71:"/var/www/chinlingcloud/public/../application/admin/view/public/nav.html";i:1531899312;}*/ ?>
...
<script>
 ...
 <div id="dcMain">
   <!-- 当前位置 -->
<div id="urHere">DouPHP 管理中心<b>></b><strong>权限分类</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
        <h3><a href="<?php echo url('admin/auth_group/auth_gadd'); ?>" class="actionBtn add">添加用户组</a>用户组管理</h3>
    <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
      ...
      <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
            <tr>
        <td align="center"> <a href="product.php?cat_id=1"><?php echo $vo['id']; ?></a></td>
        <td  align="center"><?php echo $vo['title']; ?></td>
        <td align="center"><?php echo !empty($vo['status'])?'启用':'禁用'; ?></td>
        <td align="center"><a   class="layui-btn layui-btn-sm" href="<?php echo url('admin/auth_group/auth_gedit',['id'=>$vo['id']]); ?>">编辑</a><a  class="layui-btn layui-btn-sm" href="JavaScript:" onclick="protypes_dele('确定要删除吗？',<?php echo $vo['id']; ?>)">删除</a></td>
     </tr>
      <?php endforeach; endif; else: echo "" ;endif; ?>     
          </table>
           </div>
...
function protypes_dele(message, id) {
        layer.open({
            ...
            btn : ['是','否'],
            yes : function(){
                var url="<?php echo url('admin/auth_group/auth_gdele'); ?>";
        var success_url="<?php echo url('admin/auth_group/auth_glist'); ?>";
