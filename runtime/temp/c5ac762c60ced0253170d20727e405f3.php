<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:76:"/var/www/chinlingcloud/public/../application/admin/view/operation/index.html";i:1508724095;s:65:"/var/www/chinlingcloud/public/../application/admin/view/base.html";i:1529648960;s:74:"/var/www/chinlingcloud/public/../application/admin/view/public/header.html";i:1512365842;s:71:"/var/www/chinlingcloud/public/../application/admin/view/public/nav.html";i:1508134894;}*/ ?>
...
<div id="urHere">DouPHP 管理中心<b>></b><strong>文章分类</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
    ...
    <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): if( count($data)==0 ) : echo "" ;else: foreach($data as $key=>$vo): ?>
            <tr>
        <td align="left"> <a href="product.php?cat_id=1"><?php echo $vo['ope_id']; ?></a></td>
        <td><?php echo $vo['name']; ?></td>
        <td><?php echo $vo['czstate']; ?></td>
      ...
      <a href="<?php echo url('admin/operation/index',['page'=>1]); ?>">第一页</a> 
      <a href="<?php echo url('admin/operation/index',['page'=>$page-1]); ?>">上一页</a>  
      <a href="<?php echo url('admin/operation/index',['page'=>$page+1]); ?>">下一页</a>  
      <a href="<?php echo url('admin/operation/index',['page'=>$maxPage]); ?>">最末页</a>
      </div>        
 </div>
