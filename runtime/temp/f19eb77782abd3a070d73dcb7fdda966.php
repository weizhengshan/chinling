<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"/var/www/chinlingcloud/public/../application/index/view/space/index.html";i:1520902952;s:65:"/var/www/chinlingcloud/public/../application/index/view/base.html";i:1510803549;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8" />
	...
	<body>		
		...
		<div id="main_newsdetails">
			<?php if($spacedata != NULL): ?>
			<h3 class="news_title"><?php echo $spacedata['cont_title']; ?></h3>
			<div class="news_main">
				<?php echo $spacedata['cont_text']; ?>
			</div>
			<?php else: ?>
			<div class="nolist">	
					<div>
