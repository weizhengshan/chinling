<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:77:"/var/www/chinlingcloud/public/../application/admin/view/recruit/rec_edit.html";i:1509357887;s:65:"/var/www/chinlingcloud/public/../application/admin/view/base.html";i:1529648960;s:74:"/var/www/chinlingcloud/public/../application/admin/view/public/header.html";i:1512365842;s:71:"/var/www/chinlingcloud/public/../application/admin/view/public/nav.html";i:1508134894;}*/ ?>
...
<div id="urHere">DouPHP 管理中心<b>></b><strong>添加分类</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
    ...
    <form action="" id="data_type" method="post">
     <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
      <tr>
       ...
       <td>
        <input type="text" id="rec_position" name="rec_position" value="<?php echo $data['position']; ?>" size="40" class="inpMain" />
     ...
     <tr>
       ...
       <td>
        <input type="text" id="rec_num" name="rec_num" value="<?php echo $data['num']; ?>" size="40" class="inpMain" />
    <font style="display:none" class="adrec_num" color='red'>名称不能为空！</font>
      ...
      <tr>
       ...
       <td>
        <input type="text" id="rec_place" name="rec_place" value="<?php echo $data['place']; ?>" size="40" class="inpMain" />
    ...
    UE.getEditor('content',{initialFrameWidth:800,initialFrameHeight:400,});  
        ...
        <!-- /KindEditor -->
        <textarea id="content" name="content"><?php echo $data['rec_text']; ?></textarea>
      ...
      <tr>
       ...
       <td>
        <input type="text" id="protype_sort" name="protype_sort" value="<?php echo $data['sort']; ?>" size="5" class="inpMain" />
...
var url="<?php echo url('admin/recruit/rec_edit'); ?>";
