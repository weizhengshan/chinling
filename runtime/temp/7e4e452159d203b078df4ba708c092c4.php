<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:83:"/var/www/chinlingcloud/public/../application/admin/view/protype/protypes_index.html";i:1531716684;s:65:"/var/www/chinlingcloud/public/../application/admin/view/base.html";i:1531716682;s:74:"/var/www/chinlingcloud/public/../application/admin/view/public/header.html";i:1531716684;s:71:"/var/www/chinlingcloud/public/../application/admin/view/public/nav.html";i:1531899312;}*/ ?>
...
<div id="urHere">DouPHP 管理中心<b>></b><strong>商品分类</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
        <h3><a href="<?php echo url('admin/protype/protype_add'); ?>" class="actionBtn add">添加分类</a>商品分类</h3>
    <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
	  ...
	  <?php if(is_array($arr) || $arr instanceof \think\Collection || $arr instanceof \think\Paginator): if( count($arr)==0 ) : echo "" ;else: foreach($arr as $key=>$vo): ?>
            <tr>
        <td align="left"> <a href="product.php?cat_id=1"><?php echo $vo['protype_name']; ?></a></td>
        <td><?php echo $vo['protype_describe']; ?></td>
        <td align="center"><?php echo $vo['protype_sort']; ?></td>
        <td align="center"><a  class="layui-btn layui-btn-sm" href="<?php echo url('admin/protype/protype_edit',['protype_id'=>$vo['protype_id']]); ?>">编辑</a><a  class="layui-btn layui-btn-sm" href="JavaScript:" onclick="protypes_dele('确定要删除吗？',<?php echo $vo['protype_id']; ?>)">删除</a></td>
     </tr>
      <?php endforeach; endif; else: echo "" ;endif; ?>     
          </table>
           </div>
...
function protypes_dele(message, id) {
        layer.open({
            ...
            btn : ['是','否'],
            yes : function(){
                var url="<?php echo url('admin/protype/protype_dele'); ?>";
        var success_url="<?php echo url('admin/protype/protypes_index'); ?>";
