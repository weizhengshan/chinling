<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:80:"/var/www/chinlingcloud/public/../application/admin/view/auth_rule/auth_list.html";i:1531716682;s:65:"/var/www/chinlingcloud/public/../application/admin/view/base.html";i:1531716682;s:74:"/var/www/chinlingcloud/public/../application/admin/view/public/header.html";i:1531716684;s:71:"/var/www/chinlingcloud/public/../application/admin/view/public/nav.html";i:1531899312;}*/ ?>
...
<div id="urHere">DouPHP 管理中心<b>></b><strong>权限分类</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
        <h3><a href="<?php echo url('admin/auth_rule/auth_add'); ?>" class="actionBtn add">添加分类</a>权限分类</h3>
    <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
	  ...
	  <?php if(is_array($authRuleRes) || $authRuleRes instanceof \think\Collection || $authRuleRes instanceof \think\Paginator): $i = 0; $__LIST__ = $authRuleRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
        ...
        <td align="left"><?php if($vo['level']!=0){echo '|';} echo str_repeat('—', $vo['level']*3)?><?php echo $vo['title']; ?></td>
        <td align="center"><?php echo $vo['name']; ?></td>
        <td align="center"><?php echo $vo['level']+1; ?>级</td>
        <td align="center"><a class="layui-btn layui-btn-sm" href="<?php echo url('admin/auth_rule/auth_edit',['id'=>$vo['id']]); ?>">编辑</a><a href="JavaScript:"  class="layui-btn layui-btn-sm" onclick="protypes_dele('确定要删除吗？',<?php echo $vo['id']; ?>)">删除</a></td>
     </tr>
      <?php endforeach; endif; else: echo "" ;endif; ?>     
          </table>
           </div>
...
function protypes_dele(message, id) {
        layer.open({
            ...
            btn : ['是','否'],
            yes : function(){
                var url="<?php echo url('admin/auth_rule/auth_dele'); ?>";
