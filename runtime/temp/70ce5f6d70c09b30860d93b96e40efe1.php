<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"/var/www/chinlingcloud/public/../application/index/view/news/info.html";i:1520902952;s:65:"/var/www/chinlingcloud/public/../application/index/view/base.html";i:1510803549;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8" />
	...
	<body>		
		...
		<div class='shangpu'>
 		...
 		<!--<div id="nav_newslist">-->
			<!--<ul>-->
				...
				<!--<li  <?php if($son['type_id']==$newdata['cont_pid']): ?> class="on" <?php endif; ?>>-->
		...
		<div id="main_newsdetails">
			...
			<h4 class="news_time"><?php echo date("Y-m-d H:i",$newdata['createtime']); ?></h4>
			<div class="news_main">
